# 12-Team Hiring Roadmap

## Phase 1: Solo Founder (Month 0-3) - $0
...
## Phase 2: First Hires (Month 4-6) - $500K seed

### Hire #1: Full-Stack Engineer
- **Salary:** $120K + equity
- **Role:** Ship features, fix bugs
- **Reports to:** You
- **Why first:** 2x your output immediately
- **Where to find:** YC co-founder matching, Angel.co

### Hire #2: DevOps Engineer
- **Salary:** $130K + equity
- **Role:** Infrastructure, CI/CD, security
- **Reports to:** You
- **Why:** Free you from ops work
- **Where:** Hired.com, Stack Overflow jobs

**Tools:** GitHub, Linear, Slack, AWS

---

## Phase 3: Growth Team (Month 7-12) - $3M Series A

### Hire #3: Growth Marketer
- **Salary:** $100K + equity
- **KPI:** 20% month-over-month user growth
- **Reports to:** You
- **Where:** GrowthHackers.com, indie hackers

### Hire #4: Content Marketer
- **Salary:** $90K + equity
- **KPI:** 10K organic visitors/month
- **Reports to:** Growth Marketer
- **Where:** Contently, ClearVoice

### Hire #5: Social Media Manager (Contractor)
- **Cost:** $3K/month
- **KPI:** 1K followers, 5% engagement rate
- **Reports to:** Growth Marketer
- **Where:** Upwork, Fiverr

### Hire #6: Bookkeeper (Contractor)
- **Cost:** $2K/month
- **Role:** Expenses, payroll, taxes
- **Reports to:** You
- **Where:** Bench.co, local CPA

### Hire #7: Legal Counsel (Contractor)
- **Cost:** $5K/month retainer
- **Role:** Contracts, compliance, IP
- **Reports to:** You
- **Where:** Gunderson Dettmer, Cooley LLP
